// const reader = require('./reader/readAndWrite.js');
import { luas,keliling } from './utils/mathFunction.js';
import { readAndWriteFile } from './reader/readAndWrite.js';
// const fs  = require('fs');

// soal 1 untuk menghitung luas 
// persegi
console.log(luas('persegi',3));
// persegi panjang
console.log(luas('persegi panjang',3,4));

// keliling persegi
console.log(keliling('persegi',3));
// keliling persegi panjang
console.log(keliling('persegi panjang',3,4));

//soal 2
// variabel data untuk menampung isian log
...
// untuk write dan read file 
 readAndWriteFile('log.txt',data);
